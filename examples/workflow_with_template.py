...
def semantic_search_workflow_parameters(index_name, pipeline_name, model_id, model_dimension):
    """
...
def main():
    ...
    if template_success:
        logging.info(f"Successfully set up and executed semantic search workflow: {workflow_id}")
